...
using pairXYld = std::pair<long double, long double>;
using VpairXY = std::vector<pairXY>;
using VpairXYld = std::vector<pairXYld>;
using Vmap = std::vector<std::vector<double>>;

// useful function definitions
using funcScaSca = std::function<double(const double&)>;
using funcScaVec = std::function<double(const Vector3D&)>;
using funcScaVecSca = std::function<double(const Vector3D&, const double& r)>;
using funcVecVecSca = std::function<Vector3D(const Vector3D&, const double& r)>;
using funcExit = std::function<bool(const Vector3D&, const double& r)>;
